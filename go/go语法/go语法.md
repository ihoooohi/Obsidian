...
**原因**：
![[53254281f1ede6fbcd8700e21d564875.png]]

如果等待在锁内，那等待就只能挡住一条，没意义

而且如果等待的goroutine等待的是锁外的主goroutine就会**死锁**

![[a3b604cc2b5a0c6f03b5b4557ee88d46.jpg]]
...
b := a[1:4] //左闭右开
```
![[e26030142679518b84e74370575db0bc.jpg]]
...
![[749a374e565ed3a14fe389b92674878d.jpg]]
若是
```go
a := []int{1, 2, 3}
b := a[:3]
...
```
原因：容量cap = 3不够用，触发扩容机制，b的底层数组不再是a。![[d4cfb5be04ecad9200a52c0c25b1e02b.jpg]]
...
```
![[9885c837c68deef4635c960517a4c721.jpg|450]]
